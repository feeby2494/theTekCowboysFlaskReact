                            ...
                            <Col lg={12}>
                                <div className="col-12 shadow mb-5 bg-white rounded mt-3">
                                    <Accordion className="" defaultActiveKey="1">
                                        ...
                                        <Accordion.Collapse show={show} onHide={handleClose} eventKey="1">
                                            <Card border='light'>
                                                <Card.Header>
                                                    <h2 className='h2'>Local Dallas - Ft Worth Computer and Device Repair</h2>
                                                </Card.Header>
                                                <Card.Body>
                                                    <p>Meet me local in Coppell. <a href="tel:19724409156">Text, call,</a> or <a href="mailto:toby2494@gmail.com">email me</a> if you are local! Please text me before if you want to meet me at my residence for device repair. Address is at my <a href="/about">'About Me'</a> section</p>
