...
def get_all_users(current_user):
    ...
    user_list = {}
    all_users = db.session.query(SiteUser).all()
...
def get_one_user(current_user, public_id):
    ...
    specific_user = db.session.query(SiteUser).filter_by(public_id=public_id).first()
...
def delete_user(current_user, public_id):
    ...
    user_to_delete = db.session.query(SiteUser).filter_by(public_id=public_id).first()
...
def login():
    ...
    user = SiteUser.query.filter_by(username=auth.username).first()
