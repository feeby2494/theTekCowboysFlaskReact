...
const RepairForm = (props) => {
  ...
  const submitRepairObject = (e) => {
    ...
    if (okToSubmit && validatedAddress && validatedContact) {
      submitRepair();
      handleClose();
    }
            ...
            <>
              ...
              <Form className='repair-step-one-form' noValidate validated={validatedContact} onSubmit={handleStepTwo}>
                ...
                <Form.Group className="mb-3" controlId="RepairFormModal.Email">
                  ...
                  <Form.Control  name="email" value={email} type="email" placeholder="Email" onChange={(e) => handleEmailValidation(e.target.value)} required/>
                  <Form.Control.Feedback type="invalid">
